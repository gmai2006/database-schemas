...
--
-- Host: all-prisma.de    Database: d03036d7
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='Config Data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8 COMMENT='List of data/schema patches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50013 DEFINER=`d03036d7`@`%` SQL SECURITY INVOKER */
...
-- Dump completed on 2020-02-07 13:37:35
